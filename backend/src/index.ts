...
app.get('/api/v1/users/me', authMiddleware, (req: any, res) => {
...
// Leave Requests
app.get('/api/v1/requests', authMiddleware, (req: any, res) => {
...
app.post('/api/v1/requests', authMiddleware, (req: any, res) => {
  ...
  if (balance) balance.usedDays += workingDays;
  
  res.status(201).json({ request: newRequest });
});

app.put('/api/v1/requests/:id/:action', authMiddleware, (req: any, res) => {
...
// Balance
app.get('/api/v1/balance', authMiddleware, (req: any, res) => {
  const balance = leaveBalances.find(b => b.userId === req.user.id && b.year === 2026);
  res.json({
...
// Reports (HR only)
app.get('/api/v1/reports/summary', authMiddleware, (req: any, res) => {
